      ...
      <div className="flex justify-between items-center py-5 px-6 md:px-10 lg:px-20">
        ...
        <div className="hidden md:flex items-center gap-10">
          <div className="flex gap-10 text-lg">
            <Link to="/services" className="text-gray-900 hover:text-amber-600 transition duration-300 ease-in-out">
              {t("services")}
            </Link>
            <Link to="/applications" className="text-gray-900 hover:text-amber-600 transition duration-300 ease-in-out">
              {t("applications")}
            </Link>
            ...
            >
              ...
              <div className={`absolute left-0 mt-2 w-48 border bg-amber-50 border-gray-200 rounded-md shadow-lg z-50 transition-all duration-200 ${
                ...
                <Link 
                  to="/support" 
                  className="block px-4 py-3 text-gray-900 hover:bg-amber-100 hover:text-amber-600 transition duration-200"
                >
            ...
            <Link to="/contact" className="text-gray-900 hover:text-amber-600 transition duration-300 ease-in-out">
              {t("contact")}
            </Link>
          </div>
          ...
          <div className="relative">
            <GrLanguage 
              ...
              className="text-2xl text-gray-900 hover:text-amber-600 transition duration-300 ease-in-out cursor-pointer ml-10"
            />
            {isLangDropdownOpen && (
              <div className="absolute right-0 mt-2 bg-amber-50 border border-gray-200 rounded-md shadow-lg z-50">
                <button 
                  ...
                  className={`block px-4 py-2 w-full text-left cursor-pointer ${
                    i18n.language === 'en' ? 'bg-amber-100 text-amber-600' : ''
                  }`}
                >
                  English
                </button>
                <button 
                  ...
                  className={`block px-4 py-2 w-full text-left cursor-pointer ${
                    i18n.language === 'el' ? 'bg-amber-100 text-amber-600' : ''
                  }`}
                >
                  Ελληνικά
                </button>
        ...
        <button 
          onClick={toggleMenu}
          className="md:hidden text-gray-900 hover:text-amber-600 transition duration-300"
        >
      ...
      <div className={`md:hidden border-t border-gray-300 overflow-hidden transition-all duration-300 ease-in-out ${
        ...
        <div className="flex flex-col px-6 py-4 gap-4 text-center">
          <Link 
            to="/services" 
            onClick={closeMenu}
            className="text-gray-900 hover:text-amber-600 transition duration-300 ease-in-out text-2xl py-2"
          >
            {t("services")}
          </Link>
          <Link 
          ...
          <div>
            <button 
              ...
              className="text-gray-900 hover:text-amber-600 transition duration-300 ease-in-out text-2xl py-2 w-full flex items-center justify-center gap-2"
            >
              {t("support")}
            ...
            <div className={`overflow-hidden transition-all duration-300 ${
              ...
              <Link 
                to="/support" 
                onClick={closeMenu}
                className="block text-gray-700 hover:text-amber-600 transition duration-300 ease-in-out text-lg py-2"
              >
                {t("support.designTips") || "Design Tips"}
              </Link>
              <Link 

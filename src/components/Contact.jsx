            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:outline-none focus:ring-red-800 focus:border-transparent transition duration-200"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:outline-none focus:ring-red-800 
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows="6"
                  className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:outline-none focus:ring-red-800 focus:border-transparent transition duration-200 resize-none"
              ...
              <button
                ...
                hover:bg-red-800 hover:border-red-800 hover:text-white transition-all duration-300 
          ...
          <div className="order-2">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-12 h-12 bg-red-800/10 rounded-lg flex items-center justify-center">
                ...
                <div>
                  ...
                  <a href="mailto:atelier.anadelta@gmail.com" className="text-gray-600 hover:text-red-800 transition duration-300">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+302614015715" className="text-gray-600 hover:text-red-800 transition duration-300">
                    +30 261 401 5715
                  </a>
                </div>
              </div>
              ...
              <div className="pt-6 border-t border-gray-200">
                ...
                <div className="flex gap-4">
                  <a href="#" className="w-10 h-10 bg-red-800/10 rounded-lg flex items-center justify-center text-red-800 hover:bg-red-800 hover:text-white transition-all duration-300">
